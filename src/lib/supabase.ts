...
export const getUserSubscription = async (clerkUserId: string) => {
  ...
  console.log(`[getUserSubscription] 検索開始: clerkUserId=${clerkUserId}, supabaseUrl=${supabaseUrl}`);
  ...
  try {
    ...
    console.log(`[getUserSubscription] 検索結果: clerkUserId=${clerkUserId}, data=`, data, "error=", error);
